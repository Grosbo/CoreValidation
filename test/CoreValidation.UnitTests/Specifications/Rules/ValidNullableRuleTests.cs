...
namespace CoreValidation.UnitTests.Specifications.Rules
{
    public class ValidNullableRuleTests
    {
        ...
        public static MemberSpecification<object, int> GetSingleRuleMemberSpecification(ValidateType validateType, bool isValid, string message = null, IReadOnlyCollection<IMessageArg> args = null)
        {
        ...
        public class AddingErrors
        {
            ...
            public void Should_AddError_When_Invalid(ValidationStrategy validationStrategy, ValidateType validateType)
            {
                ...
                var memberSpecification = GetSingleRuleMemberSpecification(validateType, false, "message", args);

                ValidNullableRule rule = new ValidNullableRule<object, int>(memberSpecification);
            ...
            {
                var memberSpecification = GetSingleRuleMemberSpecification(validateType, false, "message");
            ...
            {
                var memberSpecification = GetSingleRuleMemberSpecification(validateType, true, "message");
            ...
            {
                var args = new[] {new MessageArg("key", "value")};
                var memberSpecification = GetSingleRuleMemberSpecification(validateType, true, "message", args);
        ...
        public class AddingErrorsInChains
        {
            ...
            public void Should_AddDefaultError_When_Invalid_And_NoError(ValidationStrategy validationStrategy, ValidateType validateType)
            {
                ...
                var memberSpecification = GetSingleRuleMemberSpecification(validateType, false);

                var rule = new ValidNullableRule<object, int>(memberSpecification);
        ...
        public class OverridingErrorMessage
        {
            ...
            {
                var memberSpecification = GetSingleRuleMemberSpecification(validateType, false, "message", new[] {new MessageArg("key", "value")});

                var args = new[] {new MessageArg("key_overriden", "value_overriden")};

                var rule = new ValidNullableRule<object, int>(c => memberSpecification(c).WithSummaryError("message_overriden", args));
            ...
            {
                var memberSpecification = GetSingleRuleMemberSpecification(validateType, true, "message", new[] {new MessageArg("key", "value")});
        ...
        public class PasingValuesToPredicates
        {
            ...
            public void Should_PassModelToPredicate_When_ValidateRelation(ValidationStrategy validationStrategy)
            {
                ...
                MemberSpecification<object, int> memberSpecification = be => be.ValidRelative(m =>
                {
                    Assert.Same(model, m);
