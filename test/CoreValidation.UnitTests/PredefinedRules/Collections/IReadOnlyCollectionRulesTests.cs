...
namespace CoreValidation.UnitTests.PredefinedRules.Collections
{
    ...
    {
        private static readonly Func<int[], IReadOnlyCollection<int>> _convert = array => new ReadOnlyCollection<int>(array);
        ...
        public void ExactCollectionSize_Should_CollectError(IReadOnlyCollection<int> member, int size, bool expectedIsValid)
        {
        ...
        [Theory]
        [MemberData(nameof(ExactCollectionSize_Should_CollectError_Data))]
        public void ExactCollectionSize_Should_CollectError_When_LongType(IReadOnlyCollection<int> member, long size, bool expectedIsValid)
        {
            Tester.TestSingleMemberRule(
                m => m.ExactCollectionSize(size),
                member,
        ...
        {
            Tester.TestMemberRuleException<IReadOnlyCollection<int>>(
        ...
        public void NotEmptyCollection_Should_CollectError(IReadOnlyCollection<int> member, bool expectedIsValid)
        {
            Tester.TestSingleMemberRule(
        ...
        public void EmptyCollection_Should_CollectError(IReadOnlyCollection<int> member, bool expectedIsValid)
        {
            Tester.TestSingleMemberRule(
                m => m.EmptyCollection(),
                member,
        ...
        public void MaxCollectionSize_Should_CollectError(IReadOnlyCollection<int> member, int max, bool expectedIsValid)
        {
            Tester.TestSingleMemberRule(
        ...
        public void MaxCollectionSize_Should_CollectError_When_LongCollectionSize(IReadOnlyCollection<int> member, long max, bool expectedIsValid)
        {
            Tester.TestSingleMemberRule(
                m => m.MaxCollectionSize(max),
                member,
        ...
        public void MinCollectionSize_Should_CollectError(IReadOnlyCollection<int> member, int min, bool expectedIsValid)
        {
            Tester.TestSingleMemberRule(
        ...
        public void MinCollectionSize_Should_CollectError_When_LongCollectionSize(IReadOnlyCollection<int> member, long min, bool expectedIsValid)
        {
            Tester.TestSingleMemberRule(
                m => m.MinCollectionSize(min),
                member,
        ...
        public void CollectionSizeBetween_Should_CollectError(IReadOnlyCollection<int> member, int min, int max, bool expectedIsValid)
        {
            Tester.TestSingleMemberRule(
        ...
        public void CollectionSizeBetween_Should_CollectError_When_LongCollectionSize(IReadOnlyCollection<int> member, long min, long max, bool expectedIsValid)
        {
            Tester.TestSingleMemberRule(
                m => m.CollectionSizeBetween(min, max),
                member,
