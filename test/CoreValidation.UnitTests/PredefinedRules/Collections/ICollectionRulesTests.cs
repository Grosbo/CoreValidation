...
namespace CoreValidation.UnitTests.PredefinedRules.Collections
{
    ...
    public class ICollectionRulesTests
    {
        private static readonly Func<int[], ICollection<int>> _convert = array => new Collection<int>(array);
        ...
        public void ExactCollectionSize_Should_CollectError(ICollection<int> items, int expectedCollectionSize, bool expectedIsValid)
        {
        ...
        [Theory]
        [MemberData(nameof(ExactCollectionSize_Should_CollectError_Data))]
        public void ExactCollectionSize_Should_CollectError_When_LongType(ICollection<int> items, long expectedCollectionSize, bool expectedIsValid)
        {
            var builder = new MemberSpecificationBuilder<object, ICollection<int>>();
        ...
        public void NotEmptyCollection_Should_CollectError(ICollection<int> items, bool expectedIsValid)
        {
            var builder = new MemberSpecificationBuilder<object, ICollection<int>>();
        ...
        public void EmptyCollection_Should_CollectError(ICollection<int> items, bool expectedIsValid)
        {
            var builder = new MemberSpecificationBuilder<object, ICollection<int>>();
        ...
        public void MaxCollectionSize_Should_CollectError(ICollection<int> items, int maxCollectionSize, bool expectedIsValid)
        {
            var builder = new MemberSpecificationBuilder<object, ICollection<int>>();
        ...
        public void MaxCollectionSize_Should_CollectError_When_LongCollectionSize(ICollection<int> items, long maxCollectionSize, bool expectedIsValid)
        {
            var builder = new MemberSpecificationBuilder<object, ICollection<int>>();
        ...
        public void MinCollectionSize_Should_CollectError(ICollection<int> items, int minCollectionSize, bool expectedIsValid)
        {
            var builder = new MemberSpecificationBuilder<object, ICollection<int>>();
        ...
        public void MinCollectionSize_Should_CollectError_When_LongCollectionSize(ICollection<int> items, long minCollectionSize, bool expectedIsValid)
        {
            var builder = new MemberSpecificationBuilder<object, ICollection<int>>();
        ...
        public void CollectionSizeBetween_Should_CollectError(ICollection<int> items, int minCollectionSize, int maxCollectionSize, bool expectedIsValid)
        {
            var builder = new MemberSpecificationBuilder<object, ICollection<int>>();
        ...
        public void CollectionSizeBetween_Should_CollectError_When_LongCollectionSize(ICollection<int> items, long minCollectionSize, long maxCollectionSize, bool expectedIsValid)
        {
            var builder = new MemberSpecificationBuilder<object, ICollection<int>>();
