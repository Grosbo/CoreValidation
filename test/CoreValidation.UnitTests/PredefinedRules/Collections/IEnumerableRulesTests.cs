...
namespace CoreValidation.UnitTests.PredefinedRules.Collections
{
    ...
    public class IEnumerableRulesTests
    {
        private static readonly Func<int[], IEnumerable<int>> _convert = array => array;
        ...
        public void ExactCollectionSize_Should_CollectError(IEnumerable<int> items, int expectedCollectionSize, bool expectedIsValid)
        {
        ...
        [Theory]
        [MemberData(nameof(ExactCollectionSize_Should_CollectError_Data))]
        public void ExactCollectionSize_Should_CollectError_When_LongType(IEnumerable<int> items, long expectedCollectionSize, bool expectedIsValid)
        {
            var builder = new MemberSpecificationBuilder<object, IEnumerable<int>>();
        ...
        public void NotEmptyCollection_Should_CollectError(IEnumerable<int> items, bool expectedIsValid)
        {
            var builder = new MemberSpecificationBuilder<object, IEnumerable<int>>();
        ...
        public void EmptyCollection_Should_CollectError(IEnumerable<int> items, bool expectedIsValid)
        {
            var builder = new MemberSpecificationBuilder<object, IEnumerable<int>>();
        ...
        public void MaxCollectionSize_Should_CollectError(IEnumerable<int> items, int maxCollectionSize, bool expectedIsValid)
        {
            var builder = new MemberSpecificationBuilder<object, IEnumerable<int>>();
        ...
        public void MaxCollectionSize_Should_CollectError_When_LongCollectionSize(IEnumerable<int> items, long maxCollectionSize, bool expectedIsValid)
        {
            var builder = new MemberSpecificationBuilder<object, IEnumerable<int>>();
        ...
        public void MinCollectionSize_Should_CollectError(IEnumerable<int> items, int minCollectionSize, bool expectedIsValid)
        {
            var builder = new MemberSpecificationBuilder<object, IEnumerable<int>>();
        ...
        public void MinCollectionSize_Should_CollectError_When_LongCollectionSize(IEnumerable<int> items, long minCollectionSize, bool expectedIsValid)
        {
            var builder = new MemberSpecificationBuilder<object, IEnumerable<int>>();
        ...
        public void CollectionSizeBetween_Should_CollectError(IEnumerable<int> items, int minCollectionSize, int maxCollectionSize, bool expectedIsValid)
        {
            var builder = new MemberSpecificationBuilder<object, IEnumerable<int>>();
        ...
        public void CollectionSizeBetween_Should_CollectError_When_LongCollectionSize(IEnumerable<int> items, long minCollectionSize, long maxCollectionSize, bool expectedIsValid)
        {
            var builder = new MemberSpecificationBuilder<object, IEnumerable<int>>();
