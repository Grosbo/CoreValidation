...
{
    public class ReadOnlyCollectionRulesTests
    {
        private static readonly Func<int[], ReadOnlyCollection<int>> _convert = array => new ReadOnlyCollection<int>(array);
        ...
        public void ExactCollectionSize_Should_CollectError(ReadOnlyCollection<int> items, int expectedCollectionSize, bool expectedIsValid)
        {
        ...
        [Theory]
        [MemberData(nameof(ExactCollectionSize_Should_CollectError_Data))]
        public void ExactCollectionSize_Should_CollectError_When_LongType(ReadOnlyCollection<int> items, long expectedCollectionSize, bool expectedIsValid)
        {
            var builder = new MemberSpecificationBuilder<object, ReadOnlyCollection<int>>();
        ...
        public void NotEmptyCollection_Should_CollectError(ReadOnlyCollection<int> items, bool expectedIsValid)
        {
            var builder = new MemberSpecificationBuilder<object, ReadOnlyCollection<int>>();
        ...
        public void EmptyCollection_Should_CollectError(ReadOnlyCollection<int> items, bool expectedIsValid)
        {
            var builder = new MemberSpecificationBuilder<object, ReadOnlyCollection<int>>();
        ...
        public void MaxCollectionSize_Should_CollectError(ReadOnlyCollection<int> items, int maxCollectionSize, bool expectedIsValid)
        {
            var builder = new MemberSpecificationBuilder<object, ReadOnlyCollection<int>>();
        ...
        public void MaxCollectionSize_Should_CollectError_When_LongCollectionSize(ReadOnlyCollection<int> items, long maxCollectionSize, bool expectedIsValid)
        {
            var builder = new MemberSpecificationBuilder<object, ReadOnlyCollection<int>>();
        ...
        public void MinCollectionSize_Should_CollectError(ReadOnlyCollection<int> items, int minCollectionSize, bool expectedIsValid)
        {
            var builder = new MemberSpecificationBuilder<object, ReadOnlyCollection<int>>();
        ...
        public void MinCollectionSize_Should_CollectError_When_LongCollectionSize(ReadOnlyCollection<int> items, long minCollectionSize, bool expectedIsValid)
        {
            var builder = new MemberSpecificationBuilder<object, ReadOnlyCollection<int>>();
        ...
        public void CollectionSizeBetween_Should_CollectError(ReadOnlyCollection<int> items, int minCollectionSize, int maxCollectionSize, bool expectedIsValid)
        {
            var builder = new MemberSpecificationBuilder<object, ReadOnlyCollection<int>>();
        ...
        public void CollectionSizeBetween_Should_CollectError_When_LongCollectionSize(ReadOnlyCollection<int> items, long minCollectionSize, long maxCollectionSize, bool expectedIsValid)
        {
            var builder = new MemberSpecificationBuilder<object, ReadOnlyCollection<int>>();
