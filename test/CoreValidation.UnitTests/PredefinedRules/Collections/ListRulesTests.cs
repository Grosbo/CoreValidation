...
namespace CoreValidation.UnitTests.PredefinedRules.Collections
{
    public class ListRulesTests
    {
        ...
        public void ExactCollectionSize_Should_CollectError(List<int> items, int expectedCollectionSize, bool expectedIsValid)
        {
        ...
        [Theory]
        [MemberData(nameof(ExactCollectionSize_Should_CollectError_Data))]
        public void ExactCollectionSize_Should_CollectError_When_LongType(List<int> items, long expectedCollectionSize, bool expectedIsValid)
        {
            var builder = new MemberSpecificationBuilder<object, List<int>>();
        ...
        public void NotEmptyCollection_Should_CollectError(List<int> items, bool expectedIsValid)
        {
            var builder = new MemberSpecificationBuilder<object, List<int>>();
        ...
        public void EmptyCollection_Should_CollectError(List<int> items, bool expectedIsValid)
        {
            var builder = new MemberSpecificationBuilder<object, List<int>>();
        ...
        public void MaxCollectionSize_Should_CollectError(List<int> items, int maxCollectionSize, bool expectedIsValid)
        {
            var builder = new MemberSpecificationBuilder<object, List<int>>();
        ...
        public void MaxCollectionSize_Should_CollectError_When_LongCollectionSize(List<int> items, long maxCollectionSize, bool expectedIsValid)
        {
            var builder = new MemberSpecificationBuilder<object, List<int>>();
        ...
        public void MinCollectionSize_Should_CollectError(List<int> items, int minCollectionSize, bool expectedIsValid)
        {
            var builder = new MemberSpecificationBuilder<object, List<int>>();
        ...
        public void MinCollectionSize_Should_CollectError_When_LongCollectionSize(List<int> items, long minCollectionSize, bool expectedIsValid)
        {
            var builder = new MemberSpecificationBuilder<object, List<int>>();
        ...
        public void CollectionSizeBetween_Should_CollectError(List<int> items, int minCollectionSize, int maxCollectionSize, bool expectedIsValid)
        {
            var builder = new MemberSpecificationBuilder<object, List<int>>();
        ...
        public void CollectionSizeBetween_Should_CollectError_When_LongCollectionSize(List<int> items, long minCollectionSize, long maxCollectionSize, bool expectedIsValid)
        {
            var builder = new MemberSpecificationBuilder<object, List<int>>();
