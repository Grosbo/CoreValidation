...
namespace CoreValidation.UnitTests.PredefinedRules.Collections
{
    ...
    {
        private static readonly Func<int[], int[]> _convert = array => array;
        ...
        public void ExactCollectionSize_Should_CollectError(int[] items, int expectedCollectionSize, bool expectedIsValid)
        {
        ...
        [Theory]
        [MemberData(nameof(ExactCollectionSize_Should_CollectError_Data))]
        public void ExactCollectionSize_Should_CollectError_When_LongType(int[] items, long expectedCollectionSize, bool expectedIsValid)
        {
            var builder = new MemberSpecificationBuilder<object, int[]>();
        ...
        public void NotEmptyCollection_Should_CollectError(int[] items, bool expectedIsValid)
        {
            var builder = new MemberSpecificationBuilder<object, int[]>();
        ...
        public void EmptyCollection_Should_CollectError(int[] items, bool expectedIsValid)
        {
            var builder = new MemberSpecificationBuilder<object, int[]>();
        ...
        public void MaxCollectionSize_Should_CollectError(int[] items, int maxCollectionSize, bool expectedIsValid)
        {
            var builder = new MemberSpecificationBuilder<object, int[]>();
        ...
        public void MaxCollectionSize_Should_CollectError_When_LongCollectionSize(int[] items, long maxCollectionSize, bool expectedIsValid)
        {
            var builder = new MemberSpecificationBuilder<object, int[]>();
        ...
        public void MinCollectionSize_Should_CollectError(int[] items, int minCollectionSize, bool expectedIsValid)
        {
            var builder = new MemberSpecificationBuilder<object, int[]>();
        ...
        public void MinCollectionSize_Should_CollectError_When_LongCollectionSize(int[] items, long minCollectionSize, bool expectedIsValid)
        {
            var builder = new MemberSpecificationBuilder<object, int[]>();
        ...
        public void CollectionSizeBetween_Should_CollectError(int[] items, int minCollectionSize, int maxCollectionSize, bool expectedIsValid)
        {
            var builder = new MemberSpecificationBuilder<object, int[]>();
        ...
        public void CollectionSizeBetween_Should_CollectError_When_LongCollectionSize(int[] items, long minCollectionSize, long maxCollectionSize, bool expectedIsValid)
        {
            var builder = new MemberSpecificationBuilder<object, int[]>();
