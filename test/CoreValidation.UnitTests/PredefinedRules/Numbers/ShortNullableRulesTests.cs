...
namespace CoreValidation.UnitTests.PredefinedRules.Numbers
{
    public class ShortNullableRulesTests
    {
        ...
        {
            var builder = new MemberSpecificationBuilder<object, short?>();

            builder.EqualTo(value);

            RulesHelper.AssertErrorCompilation<short?>(model, builder.Rules, expectedIsValid, Phrases.Keys.Numbers.EqualTo);
        }
        ...
        public void NotEqualTo_Should_CollectError(short model, short value, bool expectedIsValid)
        {
            ...
            RulesHelper.AssertErrorCompilation<short?>(model, builder.Rules, expectedIsValid, Phrases.Keys.Numbers.NotEqualTo);
        }
        ...
        public void GreaterThan_Should_CollectError(short model, short min, bool expectedIsValid)
        {
            ...
            RulesHelper.AssertErrorCompilation<short?>(model, builder.Rules, expectedIsValid, Phrases.Keys.Numbers.GreaterThan);
        }
        ...
        public void GreaterOrEqualTo_Should_CollectError(short model, short min, bool expectedIsValid)
        {
            ...
            RulesHelper.AssertErrorCompilation<short?>(model, builder.Rules, expectedIsValid, Phrases.Keys.Numbers.GreaterOrEqualTo);
        }
        ...
        public void LessThan_Should_CollectError(short model, short max, bool expectedIsValid)
        {
            ...
            RulesHelper.AssertErrorCompilation<short?>(model, builder.Rules, expectedIsValid, Phrases.Keys.Numbers.LessThan);
        }
        ...
        public void LessOrEqualTo_Should_CollectError(short model, short max, bool expectedIsValid)
        {
            ...
            RulesHelper.AssertErrorCompilation<short?>(model, builder.Rules, expectedIsValid, Phrases.Keys.Numbers.LessOrEqualTo);
        }
        ...
        public void Between_Should_CollectError(short min, short model, short max, bool expectedIsValid)
        {
            ...
            RulesHelper.AssertErrorCompilation<short?>(model, builder.Rules, expectedIsValid, Phrases.Keys.Numbers.Between);
        }
        ...
        public void BetweenOrEqualTo_Should_CollectError(short min, short model, short max, bool expectedIsValid)
        {
            ...
            RulesHelper.AssertErrorCompilation<short?>(model, builder.Rules, expectedIsValid, Phrases.Keys.Numbers.BetweenOrEqualTo);
        }
