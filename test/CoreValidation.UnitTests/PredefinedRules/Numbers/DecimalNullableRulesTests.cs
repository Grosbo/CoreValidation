...
namespace CoreValidation.UnitTests.PredefinedRules.Numbers
{
    public class DecimalNullableRulesTests
    {
        ...
        public void EqualTo_Should_CollectError(decimal memberValue, decimal argValue, bool expectedIsValid)
        {
            Tester.TestSingleMemberRule<decimal?>(
        ...
        public void NotEqualTo_Should_CollectError(decimal memberValue, decimal argValue, bool expectedIsValid)
        {
            Tester.TestSingleMemberRule<decimal?>(
        ...
        public void GreaterThan_Should_CollectError(decimal memberValue, decimal min, bool expectedIsValid)
        {
            Tester.TestSingleMemberRule<decimal?>(
                m => m.GreaterThan(min),
                memberValue,
        ...
        public void GreaterOrEqualTo_Should_CollectError(decimal memberValue, decimal min, bool expectedIsValid)
        {
            Tester.TestSingleMemberRule<decimal?>(
        ...
        public void LessThan_Should_CollectError(decimal memberValue, decimal max, bool expectedIsValid)
        {
            Tester.TestSingleMemberRule<decimal?>(
                m => m.LessThan(max),
                memberValue,
        ...
        public void LessOrEqualTo_Should_CollectError(decimal memberValue, decimal max, bool expectedIsValid)
        {
            Tester.TestSingleMemberRule<decimal?>(
        ...
        public void Between_Should_CollectError(decimal min, decimal memberValue, decimal max, bool expectedIsValid)
        {
            Tester.TestSingleMemberRule<decimal?>(
                m => m.Between(min, max),
                memberValue,
        ...
        public void BetweenOrEqualTo_Should_CollectError(decimal min, decimal memberValue, decimal max, bool expectedIsValid)
        {
            Tester.TestSingleMemberRule<decimal?>(
