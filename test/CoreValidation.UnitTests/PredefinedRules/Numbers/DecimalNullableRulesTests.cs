...
{
    public class DecimalNullableRulesTests
    {
        ...
        {
            var builder = new MemberSpecificationBuilder<object, decimal?>();

            builder.EqualTo(value);

            RulesHelper.AssertErrorCompilation<decimal?>(model, builder.Rules, expectedIsValid, Phrases.Keys.Numbers.EqualTo);
        }
        ...
        public void NotEqualTo_Should_CollectError(decimal model, decimal value, bool expectedIsValid)
        {
            ...
            RulesHelper.AssertErrorCompilation<decimal?>(model, builder.Rules, expectedIsValid, Phrases.Keys.Numbers.NotEqualTo);
        }
        ...
        public void GreaterThan_Should_CollectError(decimal model, decimal min, bool expectedIsValid)
        {
            ...
            RulesHelper.AssertErrorCompilation<decimal?>(model, builder.Rules, expectedIsValid, Phrases.Keys.Numbers.GreaterThan);
        }
        ...
        public void GreaterOrEqualTo_Should_CollectError(decimal model, decimal min, bool expectedIsValid)
        {
            ...
            RulesHelper.AssertErrorCompilation<decimal?>(model, builder.Rules, expectedIsValid, Phrases.Keys.Numbers.GreaterOrEqualTo);
        }
        ...
        public void LessThan_Should_CollectError(decimal model, decimal max, bool expectedIsValid)
        {
            ...
            RulesHelper.AssertErrorCompilation<decimal?>(model, builder.Rules, expectedIsValid, Phrases.Keys.Numbers.LessThan);
        }
        ...
        public void LessOrEqualTo_Should_CollectError(decimal model, decimal max, bool expectedIsValid)
        {
            ...
            RulesHelper.AssertErrorCompilation<decimal?>(model, builder.Rules, expectedIsValid, Phrases.Keys.Numbers.LessOrEqualTo);
        }
        ...
        public void Between_Should_CollectError(decimal min, decimal model, decimal max, bool expectedIsValid)
        {
            ...
            RulesHelper.AssertErrorCompilation<decimal?>(model, builder.Rules, expectedIsValid, Phrases.Keys.Numbers.Between);
        }
        ...
        public void BetweenOrEqualTo_Should_CollectError(decimal min, decimal model, decimal max, bool expectedIsValid)
        {
            ...
            RulesHelper.AssertErrorCompilation<decimal?>(model, builder.Rules, expectedIsValid, Phrases.Keys.Numbers.BetweenOrEqualTo);
        }
