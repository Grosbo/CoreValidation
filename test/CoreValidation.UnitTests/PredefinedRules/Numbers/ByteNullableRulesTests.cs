...
namespace CoreValidation.UnitTests.PredefinedRules.Numbers
{
    public class ByteNullableRulesTests
    {
        ...
        public void EqualTo_Should_CollectError(byte memberValue, byte argValue, bool expectedIsValid)
        {
            Tester.TestSingleMemberRule<byte?>(
        ...
        public void NotEqualTo_Should_CollectError(byte memberValue, byte argValue, bool expectedIsValid)
        {
            Tester.TestSingleMemberRule<byte?>(
        ...
        public void GreaterThan_Should_CollectError(byte memberValue, byte min, bool expectedIsValid)
        {
            Tester.TestSingleMemberRule<byte?>(
                m => m.GreaterThan(min),
                memberValue,
        ...
        public void GreaterOrEqualTo_Should_CollectError(byte memberValue, byte min, bool expectedIsValid)
        {
            Tester.TestSingleMemberRule<byte?>(
        ...
        public void LessThan_Should_CollectError(byte memberValue, byte max, bool expectedIsValid)
        {
            Tester.TestSingleMemberRule<byte?>(
                m => m.LessThan(max),
                memberValue,
        ...
        public void LessOrEqualTo_Should_CollectError(byte memberValue, byte max, bool expectedIsValid)
        {
            Tester.TestSingleMemberRule<byte?>(
        ...
        public void Between_Should_CollectError(byte min, byte memberValue, byte max, bool expectedIsValid)
        {
            Tester.TestSingleMemberRule<byte?>(
                m => m.Between(min, max),
                memberValue,
        ...
        public void BetweenOrEqualTo_Should_CollectError(byte min, byte memberValue, byte max, bool expectedIsValid)
        {
            Tester.TestSingleMemberRule<byte?>(
