...
namespace CoreValidation.UnitTests.PredefinedRules.Numbers
{
    public class LongNullableRulesTests
    {
        ...
        public void EqualTo_Should_CollectError(long memberValue, long argValue, bool expectedIsValid)
        {
            Tester.TestSingleMemberRule<long?>(
        ...
        public void NotEqualTo_Should_CollectError(long memberValue, long argValue, bool expectedIsValid)
        {
            Tester.TestSingleMemberRule<long?>(
        ...
        public void GreaterThan_Should_CollectError(long memberValue, long min, bool expectedIsValid)
        {
            Tester.TestSingleMemberRule<long?>(
                m => m.GreaterThan(min),
                memberValue,
        ...
        public void GreaterOrEqualTo_Should_CollectError(long memberValue, long min, bool expectedIsValid)
        {
            Tester.TestSingleMemberRule<long?>(
        ...
        public void LessThan_Should_CollectError(long memberValue, long max, bool expectedIsValid)
        {
            Tester.TestSingleMemberRule<long?>(
                m => m.LessThan(max),
                memberValue,
        ...
        public void LessOrEqualTo_Should_CollectError(long memberValue, long max, bool expectedIsValid)
        {
            Tester.TestSingleMemberRule<long?>(
        ...
        public void Between_Should_CollectError(long min, long memberValue, long max, bool expectedIsValid)
        {
            Tester.TestSingleMemberRule<long?>(
                m => m.Between(min, max),
                memberValue,
        ...
        public void BetweenOrEqualTo_Should_CollectError(long min, long memberValue, long max, bool expectedIsValid)
        {
            Tester.TestSingleMemberRule<long?>(
