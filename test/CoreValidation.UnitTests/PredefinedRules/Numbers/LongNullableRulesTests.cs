...
{
    public class LongNullableRulesTests
    {
        private static readonly Func<int, long> _convert = Convert.ToInt64;
        ...
        public static IEnumerable<object[]> EqualTo_Should_CollectError_Data()
        {
            return RulesHelper.GetSetsCompilation(
                ...
                NumberDataHelper.EqualTo_Limits(long.MinValue, long.MaxValue, 1)
            );
        }

        [Theory]
        [MemberData(nameof(EqualTo_Should_CollectError_Data))]
        public void EqualTo_Should_CollectError(long model, long value, bool expectedIsValid)
        {
            var builder = new MemberSpecificationBuilder<object, long?>();

            builder.EqualTo(value);

            RulesHelper.AssertErrorCompilation<long?>(model, builder.Rules, expectedIsValid, Phrases.Keys.Numbers.EqualTo);
        }
        ...
        public static IEnumerable<object[]> NotEqualTo_Should_CollectError_Data()
        {
            return RulesHelper.GetSetsCompilation(
                ...
                NumberDataHelper.NotEqualTo_Limits(long.MinValue, long.MaxValue, 1)
            );
        }

        [Theory]
        [MemberData(nameof(NotEqualTo_Should_CollectError_Data))]
        public void NotEqualTo_Should_CollectError(long model, long value, bool expectedIsValid)
        {
            var builder = new MemberSpecificationBuilder<object, long?>();

            builder.NotEqualTo(value);

            RulesHelper.AssertErrorCompilation<long?>(model, builder.Rules, expectedIsValid, Phrases.Keys.Numbers.NotEqualTo);
        }
        ...
        public static IEnumerable<object[]> GreaterThan_Should_CollectError_Data()
        {
            return RulesHelper.GetSetsCompilation(
                ...
                NumberDataHelper.GreaterThan_Limits(long.MinValue, long.MaxValue, 1)
            );
        }

        [Theory]
        [MemberData(nameof(GreaterThan_Should_CollectError_Data))]
        public void GreaterThan_Should_CollectError(long model, long min, bool expectedIsValid)
        {
            var builder = new MemberSpecificationBuilder<object, long?>();

            builder.GreaterThan(min);

            RulesHelper.AssertErrorCompilation<long?>(model, builder.Rules, expectedIsValid, Phrases.Keys.Numbers.GreaterThan);
        }
        ...
        public static IEnumerable<object[]> GreaterOrEqualTo_Should_CollectError_Data()
        {
            return RulesHelper.GetSetsCompilation(
                ...
                NumberDataHelper.GreaterOrEqualTo_Limits(long.MinValue, long.MaxValue, 1)
            );
        }

        [Theory]
        [MemberData(nameof(GreaterOrEqualTo_Should_CollectError_Data))]
        public void GreaterOrEqualTo_Should_CollectError(long model, long min, bool expectedIsValid)
        {
            var builder = new MemberSpecificationBuilder<object, long?>();

            builder.GreaterOrEqualTo(min);

            RulesHelper.AssertErrorCompilation<long?>(model, builder.Rules, expectedIsValid, Phrases.Keys.Numbers.GreaterOrEqualTo);
        }
        ...
        public static IEnumerable<object[]> LessThan_Should_CollectError_Data()
        {
            return RulesHelper.GetSetsCompilation(
                ...
                NumberDataHelper.LessThan_Limits(long.MinValue, long.MaxValue, 1)
            );
        }

        [Theory]
        [MemberData(nameof(LessThan_Should_CollectError_Data))]
        public void LessThan_Should_CollectError(long model, long max, bool expectedIsValid)
        {
            var builder = new MemberSpecificationBuilder<object, long?>();

            builder.LessThan(max);

            RulesHelper.AssertErrorCompilation<long?>(model, builder.Rules, expectedIsValid, Phrases.Keys.Numbers.LessThan);
        }
        ...
        public static IEnumerable<object[]> LessOrEqualTo_Should_CollectError_Data()
        {
            return RulesHelper.GetSetsCompilation(
                ...
                NumberDataHelper.LessOrEqualTo_Limits(long.MinValue, long.MaxValue, 1)
            );
        }

        [Theory]
        [MemberData(nameof(LessOrEqualTo_Should_CollectError_Data))]
        public void LessOrEqualTo_Should_CollectError(long model, long max, bool expectedIsValid)
        {
            var builder = new MemberSpecificationBuilder<object, long?>();

            builder.LessOrEqualTo(max);

            RulesHelper.AssertErrorCompilation<long?>(model, builder.Rules, expectedIsValid, Phrases.Keys.Numbers.LessOrEqualTo);
        }
        ...
        public void Between_Should_CollectError(long min, long model, long max, bool expectedIsValid)
        {
            var builder = new MemberSpecificationBuilder<object, long?>();

            builder.Between(min, max);

            RulesHelper.AssertErrorCompilation<long?>(model, builder.Rules, expectedIsValid, Phrases.Keys.Numbers.Between);
        }
        ...
        public static IEnumerable<object[]> BetweenOrEqualTo_Should_CollectError_Data()
        {
            return RulesHelper.GetSetsCompilation(
                ...
                NumberDataHelper.BetweenOrEqualTo_Limits(long.MinValue, long.MaxValue, 1)
            );
        }

        [Theory]
        [MemberData(nameof(BetweenOrEqualTo_Should_CollectError_Data))]
        public void BetweenOrEqualTo_Should_CollectError(long min, long model, long max, bool expectedIsValid)
        {
            var builder = new MemberSpecificationBuilder<object, long?>();

            builder.BetweenOrEqualTo(min, max);

            RulesHelper.AssertErrorCompilation<long?>(model, builder.Rules, expectedIsValid, Phrases.Keys.Numbers.BetweenOrEqualTo);
        }
        ...
        public class MessageTests
        {
            ...
            public void Between_Should_SetCustomMessage()
            {
                ...
                RulesHelper.AssertErrorMessage<long?>(4, builder.Rules, "{min} {max} Overriden error message", "1 3 Overriden error message");
            }
            ...
            public void EqualTo_Should_SetCustomMessage()
            {
                ...
                RulesHelper.AssertErrorMessage<long?>(4, builder.Rules, "{value} Overriden error message", "0 Overriden error message");
            }
            ...
            public void GreaterOrEqual_Should_SetCustomMessage()
            {
                ...
                RulesHelper.AssertErrorMessage<long?>(1, builder.Rules, "{min} Overriden error message", "2 Overriden error message");
            }
            ...
            public void LessThan_Should_SetCustomMessage()
            {
                ...
                RulesHelper.AssertErrorMessage<long?>(2, builder.Rules, "{max} Overriden error message", "1 Overriden error message");
            }
            ...
            public void NotEqualTo_Should_SetCustomMessage()
            {
                ...
                RulesHelper.AssertErrorMessage<long?>(4, builder.Rules, "{value} Overriden error message", "4 Overriden error message");
            }
        }
    }
}