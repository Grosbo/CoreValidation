...
namespace CoreValidation.PredefinedRules.UnitTests.Numbers
{
    public class SByteNullableRulesTests
    {
        ...
        {
            var builder = new MemberSpecification<object, sbyte?>();

            builder.EqualTo(value);

            RulesHelper.AssertErrorCompilation<sbyte?>(model, builder.Rules, expectedIsValid, Phrases.Keys.Numbers.EqualTo);
        }
        ...
        public void NotEqualTo_Should_CollectError(sbyte model, sbyte value, bool expectedIsValid)
        {
            ...
            RulesHelper.AssertErrorCompilation<sbyte?>(model, builder.Rules, expectedIsValid, Phrases.Keys.Numbers.NotEqualTo);
        }
        ...
        public void GreaterThan_Should_CollectError(sbyte model, sbyte min, bool expectedIsValid)
        {
            ...
            RulesHelper.AssertErrorCompilation<sbyte?>(model, builder.Rules, expectedIsValid, Phrases.Keys.Numbers.GreaterThan);
        }
        ...
        public void GreaterOrEqualTo_Should_CollectError(sbyte model, sbyte min, bool expectedIsValid)
        {
            ...
            RulesHelper.AssertErrorCompilation<sbyte?>(model, builder.Rules, expectedIsValid, Phrases.Keys.Numbers.GreaterOrEqualTo);
        }
        ...
        public void LessThan_Should_CollectError(sbyte model, sbyte max, bool expectedIsValid)
        {
            ...
            RulesHelper.AssertErrorCompilation<sbyte?>(model, builder.Rules, expectedIsValid, Phrases.Keys.Numbers.LessThan);
        }
        ...
        public void LessOrEqualTo_Should_CollectError(sbyte model, sbyte max, bool expectedIsValid)
        {
            ...
            RulesHelper.AssertErrorCompilation<sbyte?>(model, builder.Rules, expectedIsValid, Phrases.Keys.Numbers.LessOrEqualTo);
        }
        ...
        public void Between_Should_CollectError(sbyte min, sbyte model, sbyte max, bool expectedIsValid)
        {
            ...
            RulesHelper.AssertErrorCompilation<sbyte?>(model, builder.Rules, expectedIsValid, Phrases.Keys.Numbers.Between);
        }
        ...
        public void BetweenOrEqualTo_Should_CollectError(sbyte min, sbyte model, sbyte max, bool expectedIsValid)
        {
            ...
            RulesHelper.AssertErrorCompilation<sbyte?>(model, builder.Rules, expectedIsValid, Phrases.Keys.Numbers.BetweenOrEqualTo);
        }
