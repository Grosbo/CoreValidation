    ...
    public class IntRulesTests
    {
        ...
        public class MessageTests
        {
            ...
            public void Between_Should_SetCustomMessage()
            {
                ...
                RulesHelper.AssertErrorMessage(4, builder.Rules, "{min} {max} Overriden error message", "1 3 Overriden error message");
            }
            ...
            public void EqualTo_Should_SetCustomMessage()
            {
                ...
                RulesHelper.AssertErrorMessage(4, builder.Rules, "{value} Overriden error message", "0 Overriden error message");
            }
            ...
            public void GreaterOrEqual_Should_SetCustomMessage()
            {
                ...
                RulesHelper.AssertErrorMessage(1, builder.Rules, "{min} Overriden error message", "2 Overriden error message");
            }
            ...
            public void LessThan_Should_SetCustomMessage()
            {
                ...
                RulesHelper.AssertErrorMessage(2, builder.Rules, "{max} Overriden error message", "1 Overriden error message");
            }
            ...
            public void NotEqualTo_Should_SetCustomMessage()
            {
                ...
                RulesHelper.AssertErrorMessage(4, builder.Rules, "{value} Overriden error message", "4 Overriden error message");
            }
        }
    }
}