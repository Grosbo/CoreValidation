...
{
    public class CharNumbersNullableRulesTests
    {
        ...
        public void EqualTo_Should_CollectError(char model, char value, bool expectedIsValid)
        {
            ...
            RulesHelper.AssertErrorCompilation<char?>(model, builder.Rules, expectedIsValid, Phrases.Keys.Numbers.EqualTo);
        }
        ...
        public void NotEqualTo_Should_CollectError(char model, char value, bool expectedIsValid)
        {
            ...
            RulesHelper.AssertErrorCompilation<char?>(model, builder.Rules, expectedIsValid, Phrases.Keys.Numbers.NotEqualTo);
        }
        ...
        public void GreaterThan_Should_CollectError(char model, char min, bool expectedIsValid)
        {
            ...
            RulesHelper.AssertErrorCompilation<char?>(model, builder.Rules, expectedIsValid, Phrases.Keys.Numbers.GreaterThan);
        }
        ...
        public void GreaterOrEqualTo_Should_CollectError(char model, char min, bool expectedIsValid)
        {
            ...
            RulesHelper.AssertErrorCompilation<char?>(model, builder.Rules, expectedIsValid, Phrases.Keys.Numbers.GreaterOrEqualTo);
        }
        ...
        public void LessThan_Should_CollectError(char model, char max, bool expectedIsValid)
        {
            ...
            RulesHelper.AssertErrorCompilation<char?>(model, builder.Rules, expectedIsValid, Phrases.Keys.Numbers.LessThan);
        }
        ...
        public void LessOrEqualTo_Should_CollectError(char model, char max, bool expectedIsValid)
        {
            ...
            RulesHelper.AssertErrorCompilation<char?>(model, builder.Rules, expectedIsValid, Phrases.Keys.Numbers.LessOrEqualTo);
        }
        ...
        public void Between_Should_CollectError(char min, char model, char max, bool expectedIsValid)
        {
            ...
            RulesHelper.AssertErrorCompilation<char?>(model, builder.Rules, expectedIsValid, Phrases.Keys.Numbers.Between);
        }
        ...
        public void BetweenOrEqualTo_Should_CollectError(char min, char model, char max, bool expectedIsValid)
        {
            ...
            RulesHelper.AssertErrorCompilation<char?>(model, builder.Rules, expectedIsValid, Phrases.Keys.Numbers.BetweenOrEqualTo);
        }
        ...
        public class MessageTests
        {
            ...
            public void Between_Should_SetCustomMessage()
            {
                ...
                RulesHelper.AssertErrorMessage<char?>((char)4, builder.Rules, "{min} {max} Overriden error message", "1 3 Overriden error message");
            }
            ...
            public void EqualTo_Should_SetCustomMessage()
            {
                ...
                RulesHelper.AssertErrorMessage<char?>((char)4, builder.Rules, "{value} Overriden error message", "0 Overriden error message");
            }
            ...
            public void GreaterOrEqual_Should_SetCustomMessage()
            {
                ...
                RulesHelper.AssertErrorMessage<char?>((char)1, builder.Rules, "{min} Overriden error message", "2 Overriden error message");
            }
            ...
            public void LessThan_Should_SetCustomMessage()
            {
                ...
                RulesHelper.AssertErrorMessage<char?>((char)2, builder.Rules, "{max} Overriden error message", "1 Overriden error message");
            }
            ...
            public void NotEqualTo_Should_SetCustomMessage()
            {
                ...
                RulesHelper.AssertErrorMessage<char?>((char)4, builder.Rules, "{value} Overriden error message", "4 Overriden error message");
            }
        }
    }
}