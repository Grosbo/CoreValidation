        ...
        public class ComparisonModesTests
        {
            ...
            public class MessageTests
            {
                ...
                public void Between_Should_SetCustomMessage()
                {
                    ...
                    RulesHelper.AssertErrorMessage(new DateTimeOffset(2020, 09, 21, 15, 0, 4, TimeSpan.Zero), builder.Rules, "{min} {max} {timeComparison} Overriden error message", "2020-09-21 15:00:01 2020-09-21 15:00:03 All Overriden error message");
                }
                ...
                public void EqualTo_Should_SetCustomMessage()
                {
                    ...
                    RulesHelper.AssertErrorMessage(new DateTimeOffset(2020, 09, 21, 15, 0, 4, TimeSpan.Zero), builder.Rules, "{value} {timeComparison} Overriden error message", "2020-09-21 15:00:00 All Overriden error message");
                }
                ...
                public void GreaterOrEqual_Should_SetCustomMessage()
                {
                    ...
                    RulesHelper.AssertErrorMessage(new DateTimeOffset(2020, 09, 21, 15, 0, 1, TimeSpan.Zero), builder.Rules, "{min} {timeComparison} Overriden error message", "2020-09-21 15:00:02 All Overriden error message");
                }
                ...
                public void LessThan_Should_SetCustomMessage()
                {
                    ...
                    RulesHelper.AssertErrorMessage(new DateTimeOffset(2020, 09, 21, 15, 0, 2, TimeSpan.Zero), builder.Rules, "{max} {timeComparison} Overriden error message", "2020-09-21 15:00:01 All Overriden error message");
                }
                ...
                public void NotEqualTo_Should_SetCustomMessage()
                {
                    ...
                    RulesHelper.AssertErrorMessage(new DateTimeOffset(2020, 09, 21, 15, 0, 4, TimeSpan.Zero), builder.Rules, "{value} {timeComparison} Overriden error message", "2020-09-21 15:00:04 All Overriden error message");
                }
            }
        }
    }
