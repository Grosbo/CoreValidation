...
namespace CoreValidation.PredefinedRules.UnitTests.Collections
{
    ...
    public class IReadOnlyCollectionRulesTests
    {
        ...
        public void ExactSize_Should_CollectError(IReadOnlyCollection<int> items, int expectedSize, bool expectedIsValid)
        {
            var builder = new MemberSpecification<object, IReadOnlyCollection<int>>();
        ...
        [Theory]
        [MemberData(nameof(ExactSize_Should_CollectError_Data))]
        public void ExactSize_Should_CollectError_When_LongType(IReadOnlyCollection<int> items, long expectedSize, bool expectedIsValid)
        {
            var builder = new MemberSpecification<object, IReadOnlyCollection<int>>();
        ...
        public void NotEmpty_Should_CollectError(IReadOnlyCollection<int> items, bool expectedIsValid)
        {
            var builder = new MemberSpecification<object, IReadOnlyCollection<int>>();
        ...
        public void Empty_Should_CollectError(IReadOnlyCollection<int> items, bool expectedIsValid)
        {
            var builder = new MemberSpecification<object, IReadOnlyCollection<int>>();
        ...
        public void MaxSize_Should_CollectError(IReadOnlyCollection<int> items, int maxSize, bool expectedIsValid)
        {
            var builder = new MemberSpecification<object, IReadOnlyCollection<int>>();
        ...
        public void MaxSize_Should_CollectError_When_LongSize(IReadOnlyCollection<int> items, long maxSize, bool expectedIsValid)
        {
            var builder = new MemberSpecification<object, IReadOnlyCollection<int>>();
        ...
        public void MinSize_Should_CollectError(IReadOnlyCollection<int> items, int minSize, bool expectedIsValid)
        {
            var builder = new MemberSpecification<object, IReadOnlyCollection<int>>();
        ...
        public void MinSize_Should_CollectError_When_LongSize(IReadOnlyCollection<int> items, long minSize, bool expectedIsValid)
        {
            var builder = new MemberSpecification<object, IReadOnlyCollection<int>>();
        ...
        public void SizeBetween_Should_CollectError(IReadOnlyCollection<int> items, int minSize, int maxSize, bool expectedIsValid)
        {
            var builder = new MemberSpecification<object, IReadOnlyCollection<int>>();
        ...
        public void SizeBetween_Should_CollectError_When_LongSize(IReadOnlyCollection<int> items, long minSize, long maxSize, bool expectedIsValid)
        {
            var builder = new MemberSpecification<object, IReadOnlyCollection<int>>();
