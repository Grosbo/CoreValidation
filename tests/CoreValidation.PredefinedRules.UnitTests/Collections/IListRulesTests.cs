...
namespace CoreValidation.PredefinedRules.UnitTests.Collections
{
    ...
    public class IListRulesTests
    {
        ...
        public void ExactSize_Should_CollectError(IList<int> items, int expectedSize, bool expectedIsValid)
        {
            var builder = new MemberSpecification<object, IList<int>>();
        ...
        [Theory]
        [MemberData(nameof(ExactSize_Should_CollectError_Data))]
        public void ExactSize_Should_CollectError_When_LongType(IList<int> items, long expectedSize, bool expectedIsValid)
        {
            var builder = new MemberSpecification<object, IList<int>>();
        ...
        public void NotEmpty_Should_CollectError(IList<int> items, bool expectedIsValid)
        {
            var builder = new MemberSpecification<object, IList<int>>();
        ...
        public void Empty_Should_CollectError(IList<int> items, bool expectedIsValid)
        {
            var builder = new MemberSpecification<object, IList<int>>();
        ...
        public void MaxSize_Should_CollectError(IList<int> items, int maxSize, bool expectedIsValid)
        {
            var builder = new MemberSpecification<object, IList<int>>();
        ...
        public void MaxSize_Should_CollectError_When_LongSize(IList<int> items, long maxSize, bool expectedIsValid)
        {
            var builder = new MemberSpecification<object, IList<int>>();
        ...
        public void MinSize_Should_CollectError(IList<int> items, int minSize, bool expectedIsValid)
        {
            var builder = new MemberSpecification<object, IList<int>>();
        ...
        public void MinSize_Should_CollectError_When_LongSize(IList<int> items, long minSize, bool expectedIsValid)
        {
            var builder = new MemberSpecification<object, IList<int>>();
        ...
        public void SizeBetween_Should_CollectError(IList<int> items, int minSize, int maxSize, bool expectedIsValid)
        {
            var builder = new MemberSpecification<object, IList<int>>();
        ...
        public void SizeBetween_Should_CollectError_When_LongSize(IList<int> items, long minSize, long maxSize, bool expectedIsValid)
        {
            var builder = new MemberSpecification<object, IList<int>>();
