...
namespace CoreValidation.PredefinedRules.UnitTests.Collections
{
    public class ListRulesTests
    {
        ...
        public void ExactSize_Should_CollectError(List<int> items, int expectedSize, bool expectedIsValid)
        {
            var builder = new MemberSpecification<object, List<int>>();
        ...
        [Theory]
        [MemberData(nameof(ExactSize_Should_CollectError_Data))]
        public void ExactSize_Should_CollectError_When_LongType(List<int> items, long expectedSize, bool expectedIsValid)
        {
            var builder = new MemberSpecification<object, List<int>>();
        ...
        public void NotEmpty_Should_CollectError(List<int> items, bool expectedIsValid)
        {
            var builder = new MemberSpecification<object, List<int>>();
        ...
        public void Empty_Should_CollectError(List<int> items, bool expectedIsValid)
        {
            var builder = new MemberSpecification<object, List<int>>();
        ...
        public void MaxSize_Should_CollectError(List<int> items, int maxSize, bool expectedIsValid)
        {
            var builder = new MemberSpecification<object, List<int>>();
        ...
        public void MaxSize_Should_CollectError_When_LongSize(List<int> items, long maxSize, bool expectedIsValid)
        {
            var builder = new MemberSpecification<object, List<int>>();
        ...
        public void MinSize_Should_CollectError(List<int> items, int minSize, bool expectedIsValid)
        {
            var builder = new MemberSpecification<object, List<int>>();
        ...
        public void MinSize_Should_CollectError_When_LongSize(List<int> items, long minSize, bool expectedIsValid)
        {
            var builder = new MemberSpecification<object, List<int>>();
        ...
        public void SizeBetween_Should_CollectError(List<int> items, int minSize, int maxSize, bool expectedIsValid)
        {
            var builder = new MemberSpecification<object, List<int>>();
        ...
        public void SizeBetween_Should_CollectError_When_LongSize(List<int> items, long minSize, long maxSize, bool expectedIsValid)
        {
            var builder = new MemberSpecification<object, List<int>>();
