...
namespace CoreValidation.PredefinedRules.UnitTests.Collections
{
    ...
    public class IEnumerableRulesTests
    {
        ...
        public void ExactSize_Should_CollectError(IEnumerable<int> items, int expectedSize, bool expectedIsValid)
        {
            var builder = new MemberSpecification<object, IEnumerable<int>>();
        ...
        [Theory]
        [MemberData(nameof(ExactSize_Should_CollectError_Data))]
        public void ExactSize_Should_CollectError_When_LongType(IEnumerable<int> items, long expectedSize, bool expectedIsValid)
        {
            var builder = new MemberSpecification<object, IEnumerable<int>>();
        ...
        public void NotEmpty_Should_CollectError(IEnumerable<int> items, bool expectedIsValid)
        {
            var builder = new MemberSpecification<object, IEnumerable<int>>();
        ...
        public void Empty_Should_CollectError(IEnumerable<int> items, bool expectedIsValid)
        {
            var builder = new MemberSpecification<object, IEnumerable<int>>();
        ...
        public void MaxSize_Should_CollectError(IEnumerable<int> items, int maxSize, bool expectedIsValid)
        {
            var builder = new MemberSpecification<object, IEnumerable<int>>();
        ...
        public void MaxSize_Should_CollectError_When_LongSize(IEnumerable<int> items, long maxSize, bool expectedIsValid)
        {
            var builder = new MemberSpecification<object, IEnumerable<int>>();
        ...
        public void MinSize_Should_CollectError(IEnumerable<int> items, int minSize, bool expectedIsValid)
        {
            var builder = new MemberSpecification<object, IEnumerable<int>>();
        ...
        public void MinSize_Should_CollectError_When_LongSize(IEnumerable<int> items, long minSize, bool expectedIsValid)
        {
            var builder = new MemberSpecification<object, IEnumerable<int>>();
        ...
        public void SizeBetween_Should_CollectError(IEnumerable<int> items, int minSize, int maxSize, bool expectedIsValid)
        {
            var builder = new MemberSpecification<object, IEnumerable<int>>();
        ...
        public void SizeBetween_Should_CollectError_When_LongSize(IEnumerable<int> items, long minSize, long maxSize, bool expectedIsValid)
        {
            var builder = new MemberSpecification<object, IEnumerable<int>>();
