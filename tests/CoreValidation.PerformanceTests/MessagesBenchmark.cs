...
namespace CoreValidation.PerformanceTests
{
    ...
    public class MessagesBenchmark
    {
        ...
        {
            Validator<LoginModel> validator = specs => specs
                .For(m => m.Email, be => be
                    .Valid(v => false)
                    .Valid(v => false)
                    .Valid(v => false)
            ...
            _defaultsValidationContext = ValidationContext.Factory.Create(options => options.AddValidator(validator));
        }
        ...
        private void MessagesSetup()
        {
            ...
            _messagesValidationContext = ValidationContext.Factory.Create(options => options.AddValidator(validator));
        }
        ...
        private void ArgsSetup()
        {
            ...
            _argsValidationContext = ValidationContext.Factory.Create(options => options.AddValidator(validator));
        }
        ...
        private void FormatsSetup()
        {
            ...
            _formatsValidationContext = ValidationContext.Factory.Create(options => options.AddValidator(validator));
        }
