...
namespace CoreValidation.UnitTests.Errors
{
    public class MessageStringifierTests
    {
        ...
        public void Should_NotPassParameters_When_ContainsInvalidParameters()
        {
            ...
            var result = new MessageStringifier().Stringify("test {arg|param=x|someparameter=somevalue}", new IMessageArg[] {arg});
        ...
        public void Should_PassParameters_When_ManyArguments()
        {
            ...
            var result = new MessageStringifier().Stringify("test {arg|param=x|param2=x2|param3=x3} {arg2|par=val}", new IMessageArg[] {arg, arg2});
        ...
        public void Should_PassParameters_When_ManyParameters()
        {
            ...
            var result = new MessageStringifier().Stringify("test {arg|param=x|param2=x2|param3=x3}", new IMessageArg[] {arg});
        ...
        public void Should_PassParameters_When_SingleParameter()
        {
            ...
            var result = new MessageStringifier().Stringify("test {arg|param=x}", new IMessageArg[] {arg});
        ...
        public void Should_ReturnSameString_When_ArgumentNotUsed()
        {
            ...
            var result = new MessageStringifier().Stringify("test", new IMessageArg[] {arg});
        ...
        {
            var result = new MessageStringifier().Stringify("test", new IMessageArg[] { });
        ...
        {
            var result = new MessageStringifier().Stringify("test", null);
        ...
        public void Should_ReturnSameString_When_UsingInvalidName()
        {
            ...
            var result = new MessageStringifier().Stringify("test {argument}", new IMessageArg[] {arg});
        ...
        public void Should_Stringify_When_ManyVariables()
        {
            ...
            var result = new MessageStringifier().Stringify("test {arg} {arg2}", new IMessageArg[] {arg, arg2});
        ...
        public void Should_Stringify_When_OnlyUsedArguments()
        {
            ...
            var result = new MessageStringifier().Stringify("test {arg} {arg2} {arg3}", new IMessageArg[] {arg, arg2});
        ...
        public void Should_Stringify_When_SingleVariable()
        {
            ...
            var result = new MessageStringifier().Stringify("test {arg}", new IMessageArg[] {arg});
        ...
        public void Should_Stringify_When_SingleVariable_ManyOccurances()
        {
            ...
            var result = new MessageStringifier().Stringify("test {arg} {arg}", new IMessageArg[] {arg});
        ...
        {
            Assert.Throws<ArgumentException>(() => { new MessageStringifier().Stringify("test {arg}", new IMessageArg[] {new MessageArg("arg", "value1"), new MessageArg("arg", "value2")}); });
        }

        [Fact]
        public void Should_ThrowException_When_NullMessage()
        {
            Assert.Throws<ArgumentNullException>(() => { new MessageStringifier().Stringify(null, new IMessageArg[] { }); });
        }
    }
}