...
namespace CoreValidation.UnitTests.Errors
{
    public class MessageVariablesParserTests
    {
        ...
        {
            var variables = new MessageVariablesParser().Parse(message);
        ...
        {
            var variables = new MessageVariablesParser().Parse("abc  {invalid|param1=value1|param1=value2} def");
        ...
        {
            var variables = new MessageVariablesParser().Parse("abc {single|param1=value1}  def {single|param1=value1}");
        ...
        {
            var variables = new MessageVariablesParser().Parse("abc {first|p1=v1} {first|p21=v21|p22=v22} def {first}");
        ...
        {
            var variables = new MessageVariablesParser().Parse("abc {first} {second} def {third}");
        ...
        {
            var variables = new MessageVariablesParser().Parse("abc {first|p1=v1} {second|p21=v21|p22=v22} def {third|p31=v31|p32=v32|p33=v33}");
        ...
        {
            var variables = new MessageVariablesParser().Parse("abc {single} def");
        ...
        {
            var variables = new MessageVariablesParser().Parse("abc {single|param1=value1|param2=value2|param3=value3} def");
        ...
        {
            var variables = new MessageVariablesParser().Parse("abc {single|param1=value1} def");
        ...
        {
            var variables = new MessageVariablesParser().Parse("{valid} abc {invalid|param1=value1|param1=value2} {valid2|param=value} def {invalid|param1=value1param1=value2} xyz {invalid|param1value1param1value2}");
        ...
        {
            Assert.Throws<ArgumentNullException>(() => { new MessageVariablesParser().Parse(null); });
        }
    }
}