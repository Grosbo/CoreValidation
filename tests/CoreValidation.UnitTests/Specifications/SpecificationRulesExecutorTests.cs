...
{
    public class SpecificationRulesExecutorTests
    {
        public class ModelScopeRules
        {
            ...
            public void Should_GatherNoErrors_When_NoRules(ValidationStrategy validationStrategy)
            {
                ...
                var errorsCollection = SpecificationRulesExecutor.ExecuteSpecificationRules(specification, user, new RulesExecutionContext
                    {
            ...
            public void Should_ThrowException_When_MaxDepthExceeded()
            {
                ...
                {
                    SpecificationRulesExecutor.ExecuteSpecificationRules(specification, new User(), new RulesExecutionContext
                    {
                        RulesOptions = new RulesOptionsStub
                        {
                            MaxDepth = 5
        ...
        public class NullableMemberScope
        {
            ...
            public void Should_Pass_Values()
            {
                ...
                SpecificationRulesExecutor.ExecuteSpecificationRules(specification, user, new RulesExecutionContext
                    {
                        RulesOptions = new RulesOptionsStub(),
                        ValidationStrategy = ValidationStrategy.Complete
                    },
        ...
        public class ModelMemberScope
        {
            ...
            public void Should_UseValidatorFromSelectedSource(bool useDefined)
            {
                ...
                Validator<Address> fromRepository = m => m
                    .Valid(n =>
                    {
                        Assert.Equal(user.Address, n);
