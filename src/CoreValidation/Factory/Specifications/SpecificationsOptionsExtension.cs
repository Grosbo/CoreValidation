...
namespace CoreValidation
{
    public static class SpecificationsOptionsExtension
    {
        ...
        /// </summary>
        /// <param name="options"></param>
        /// <param name="specificationsHolder">Object that contains specifications. Should implement at least one <see cref="ISpecificationHolder{T}"/>.</param>
        /// <returns></returns>
        /// <exception cref="ArgumentNullException">Thrown if <paramref name="specificationsHolder"/> is null.</exception>
        /// <exception cref="InvalidOperationException">Thrown if <paramref name="specificationsHolder"/> doesn't contain specifications.</exception>
