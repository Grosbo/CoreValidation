...
namespace CoreValidation.Specifications
{
        ...
        where TModel : class
    {
        ...
        /// </summary>
        /// <param name="isValid">Predicate determining if the current member is valid as a relative. The parent model is provided in the predicate.</param>
        ...
        /// If placed after command that can return multiple error messages (like 'AsModel', 'AsCollection', etc.), replaces them all as a single error message.
        /// </summary>
        /// <param name="message">Error message</param>
        /// <exception cref="ArgumentNullException">Thrown when <paramref name="message"/> is null</exception>
