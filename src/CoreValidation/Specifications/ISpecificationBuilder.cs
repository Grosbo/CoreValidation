...
namespace CoreValidation.Specifications
{
        ...
        where TModel : class
    {
        ...
        ///     Thrown when <paramref name="memberSelector" /> is not pointing at property (but
        ///     e.g. a field or method)
        /// </exception>
        ...
        /// <summary>
        ///     Sets (and overrides) the error message of the preceding command. If placed after 'Member', replaces all errors from
        ///     its scope.
        /// </summary>
        /// <param name="message">Error message.</param>
        /// <exception cref="ArgumentNullException">Thrown when <paramref name="message" /> is null</exception>
